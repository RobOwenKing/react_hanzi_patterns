  ...
  render() {
    return (
      <footer>
        ...
        <div>Built using data from <a href="https://github.com/skishore/makemeahanzi" target="_blank" rel="noopener noreferrer">Make Me A Hanzi</a> under the <a href="https://github.com/skishore/makemeahanzi/blob/master/LGPL" target="_blank" rel="noopener noreferrer">GNU Lesser General Public License</a>.</div>
